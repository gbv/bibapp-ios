...
- (void)initConfiguration
{
   ...
   self.currentBibLocalSearchURL = @"opac-de";
   [self.currentBibLocalSearchURLs addObject:[[NSArray alloc] initWithObjects:@"opac-de", @"Standard-Katalog", @"Lokale Suche", @"Lokale Suche", nil]];
   self.currentBibDetailURL = @"http://daia.gbv.de/isil/DE";
   [self.currentBibDetailURLs addObject:[[NSArray alloc] initWithObjects:@"http://daia.gbv.de/isil/DE", @"Standard-Katalog", nil]];
   self.currentBibPAIAURL = @"https://paia.gbv.de/DE-84";
   [self.currentBibPAIAURLs addObject:[[NSArray alloc] initWithObjects:@"https://paia.gbv.de/DE", @"Standard-Katalog", nil]];
   ...
   self.currentBibLocationURI = @"http://uri.gbv.de/organization/isil/DE";
   [self.currentBibLocationURIs addObject:[[NSArray alloc] initWithObjects:@"http://uri.gbv.de/organization/isil/DE", @"Standard-Katalog", nil]];
