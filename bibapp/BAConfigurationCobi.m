...
- (void)initConfiguration
{
   ...
   self.currentBibImprintTitles = [[NSMutableArray alloc] initWithObjects:@"Anbieter im Sinne von § 5 TMG", @"Vertretungsberechtigte", @"Präses", @"Stellvertretender Hauptgeschäftsführer", @"Aufsichtsbehörde", @"Angaben zum Datenschutz", @"Rechtliche Hinweise zur Haftung", @"Gestaltung und Umsetzung", nil];
   ...
   [self.currentBibImprint setObject:@"Tobias Bergmann\nAdolphsplatz 1\n20457 Hamburg\nTelefon +49 40 36138-138\nTelefax +49 40 36138-401\nE-Mail service@hk24.de" forKey:@"Präses"];
   [self.currentBibImprint setObject:@"Ulrich Brehmer\nAdolphsplatz 1\n20457 Hamburg\nTelefon +49 40 36138-138\nTelefax +49 40 36138-401\nE-Mail service@hk24.de\n\nUmsatzsteuer-Identifikationsnummer:\nDE 118510412" forKey:@"Stellvertretender Hauptgeschäftsführer"];
