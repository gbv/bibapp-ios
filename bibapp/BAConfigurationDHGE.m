...
- (void)initConfiguration
{
    ...
    self.currentBibFeedURL = @"http://...dhge.de";
    [self.currentBibFeedURLs addObject:[[NSArray alloc] initWithObjects:@"http://...dhge.de", @"Gera", nil]];
    [self.currentBibFeedURLs addObject:[[NSArray alloc] initWithObjects:@"http://...dhge.de", @"Eisenach", nil]];
