...
- (void)initConfiguration
{
    ...
    [self.currentBibLocalSearchURLs addObject:[[NSArray alloc] initWithObjects:@"opac-de-hil3-3", @"Holzminden, Bauwesen, Soziale Arbeit, Bauen", @"Lokale Suche MSB", @"Lokale Suche MSB", nil]];
