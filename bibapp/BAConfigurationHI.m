...
- (void)initConfiguration
{
    ...
    self.currentBibPAIAURL = @"https://paia.gbv.de/test/DE-Hil";
    [self.currentBibPAIAURLs addObject:[[NSArray alloc] initWithObjects:@"https://paia.gbv.de/test/DE-Hil", @"Standard-Katalog", nil]];
