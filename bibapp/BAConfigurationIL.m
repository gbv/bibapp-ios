...
- (void)initConfiguration
{
    ...
    [self.currentBibImprint setObject:@"Die Universitätsbibliothek setzt den Webanalysedienst Piwik zur Verbesserung und Optimierung des Angebotes ein. Die IP-Adressen der zugreifenden Geräte werden unmittelbar beim Zugriff anonymisiert und anonymisiert gespeichert. Die erlangten Informationen werden nicht an Dritte weitergegeben, eine Zusammenführung der erhobenen Nutzerdaten und möglicher Ausleihdaten erfolgt nicht.\nSie haben die Möglichkeit, die Erhebung der Daten im Menü \"Einstellungen\" im Punkt \"Anonyme Nutzungsdaten speichern\" zu deaktivieren." forKey:@"Zählpixelverfahren Deutsche Bibliotheksstatistik"];
