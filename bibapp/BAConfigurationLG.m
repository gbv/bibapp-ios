...
- (void)initConfiguration{
    ...
    self.currentBibFeedURL = @"http://www.leuphana.de/services/miz/aktuell/blog/miz-blog-list.html?type=100&tx_t3blog_pi1[rss][feed_id]=2.0&tx_t3blog_pi1[rss][feed_type]=post";
