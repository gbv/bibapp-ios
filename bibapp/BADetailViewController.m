        ...
        if (self.currentEntry.onlineLocation == nil) {
            ...
            if (tempDocumentItem.order) {
                if (tempDocumentItem.location != nil) {
                    action = [[UIActionSheet alloc] initWithTitle:nil
                                           ...
                                           destructiveButtonTitle:nil
                                                otherButtonTitles:orderString, NSLocalizedString(@"Standortinfo", nil), nil];
                } else {
                    action = [[UIActionSheet alloc] initWithTitle:nil
                                                         delegate:self
                                                cancelButtonTitle:NSLocalizedString(@"Abbrechen", nil)
                ...
                action = [[UIActionSheet alloc] initWithTitle:nil
                                            ...
                                            cancelButtonTitle:NSLocalizedString(@"Abbrechen", nil)
                                       destructiveButtonTitle:nil
                                            otherButtonTitles:NSLocalizedString(@"Standortinfo", nil), nil];
            }
            ...
            UIActionSheet *action = [[UIActionSheet alloc] initWithTitle:nil
                                            ...
                                            cancelButtonTitle:NSLocalizedString(@"Abbrechen", nil)
                                       destructiveButtonTitle:nil
                                            otherButtonTitles:NSLocalizedString(@"Im Browser öffnen", nil), nil];
            [action setTag:indexPath.row+1];
            [action showInView:self.scrollViewController.parentViewController.parentViewController.view];
...
- (void)actionButton
{
    UIActionSheet *action = [[UIActionSheet alloc] initWithTitle:nil
                               ...
                               cancelButtonTitle:NSLocalizedString(@"Abbrechen", nil)
                          destructiveButtonTitle:nil
                               otherButtonTitles:NSLocalizedString(@"Zur Merkliste hinzufügen", nil), nil];
    [action setTag:0];
    [action showInView:self.scrollViewController.parentViewController.parentViewController.view];
}
