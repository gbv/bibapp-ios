                            ...
                            Height:(CGFloat)barcodeh        // Barcode Height
{
    ...
    CGRect croppedRect = CGRectMake(0, 0, x, barcodeh);
    CGImageRef imageRef = CGImageCreateWithImageInRect([resultingImage CGImage], croppedRect);
    resultingImage = [UIImage imageWithCGImage:imageRef];
