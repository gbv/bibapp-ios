...
+ (id)nodeConsumingXMLNode:(xmlNodePtr)theXMLNode {
  ...
  //eww return [[[theClass alloc] initConsumingXMLNode:theXMLNode] autorelease];
...
+ (id)nodeBorrowingXMLNode:(xmlNodePtr)theXMLNode {
  ...
  //eww return [[[theClass alloc] initBorrowingXMLNode:theXMLNode] autorelease];
...
- (void)releaseCachedValues {
  ...
  //eww [cachedName_ release];
  cachedName_ = nil;

  //eww [cachedChildren_ release];
  cachedChildren_ = nil;

  //eww [cachedAttributes_ release];
...
- (NSString *)XMLString {
  ...
  if (xmlNode_ != NULL) {
    ...
    if (buff) {
      ...
      if (result > -1) {
        //eww str = [[[NSString alloc] initWithBytes:(xmlBufferContent(buff))
...
- (NSArray *)children {
  ...
  if (xmlNode_ != NULL) {
    ...
    //eww cachedChildren_ = [array retain];
  }
  return array;
}
...
- (NSArray *)attributes {
  ...
  if (xmlNode_ != NULL && xmlNode_->properties != NULL) {
    ...
    //eww cachedAttributes_ = [array retain];
  }
  return array;
}
